...
const BANKS = [
  { code: '000001', name: 'First Bank of Nigeria', supportsVerification: true },
  { code: '000002', name: 'UBA', supportsVerification: true },
  { code: '000003', name: 'Globus Bank', supportsVerification: true },
  { code: '000004', name: 'Zenith Bank', supportsVerification: true },
  { code: '000005', name: 'Access Bank', supportsVerification: true },
  { code: '000007', name: 'FCMB', supportsVerification: true },
  { code: '000008', name: 'Sterling Bank', supportsVerification: true },
  { code: '000009', name: 'Wema Bank', supportsVerification: true },
  { code: '000010', name: 'Trustbond', supportsVerification: true },
  { code: '000011', name: 'Unity Bank', supportsVerification: true },
  { code: '000012', name: 'Stanbic IBTC', supportsVerification: true },
  { code: '000013', name: 'Standard Chartered', supportsVerification: true },
  { code: '000014', name: 'Suntrust Bank', supportsVerification: true },
  { code: '000015', name: 'Providus Bank', supportsVerification: true },
  { code: '000016', name: 'Jaiz Bank', supportsVerification: true },
  { code: '000017', name: 'Heritage Bank', supportsVerification: true },
  { code: '000018', name: 'Keystone Bank', supportsVerification: true },
  { code: '000019', name: 'Polaris Bank', supportsVerification: true },
  { code: '000020', name: 'Titan Trust Bank', supportsVerification: true },
  { code: '000021', name: 'Union Bank', supportsVerification: true },
  { code: '000022', name: 'Ecobank', supportsVerification: true },
  { code: '000023', name: 'Fidelity Bank', supportsVerification: true },
  { code: '000031', name: 'Moniepoint', supportsVerification: true },
  { code: '000032', name: 'Kuda Bank', supportsVerification: true },
  { code: '000033', name: 'Opay', supportsVerification: true },
  { code: '000034', name: 'Palmpay', supportsVerification: true },
];
